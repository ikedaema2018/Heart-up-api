class LocateInfosController < ApplicationController
  ...
  def show
    ...
    render json: @locate_info, include: ['nayami_comments', 'nayami_comments.reactions' 'nayami_comments.user', 'nayami_comments.reply_comments', 'nayami_comments.reply_comments.reactions', 'nayami_comments.reply_comments.user','user', 'first_locate']
  end
